...
map = [[Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall(), Wall()],
       [Wall(), Tools(), Wall(), None  , Bomb(980, "A"), Wall(), None  , Wall(), Bomb(1060, "A"), None  , None  , None  , None  , Wall()],
       ...
       [Wall(), None  , Wall(), Bomb(1060, "A"), None  , None  , None  , None  , None  , Wall(), None  , Wall(), None  , Wall()],
       ...
       [Wall(), None  , Wall(), None  , Wall(), None  , Wall(), Bomb(1060, "A"), Wall(), None  , Wall(), Wall(), None  , Wall()],
       ...
       [Wall(), Bomb(1000, "A"), Wall(), None  , None  , None  , None  , None  , None  , None  , Wall(), Bomb(1060, "A"), None, Wall()],
